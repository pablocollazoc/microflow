...
class ResultsGenerator:
    def __init__(self):
        sonar = SonarQubeClient(
            sonarqube_url="http://localhost:9000", username="admin", password="admin", TOKEN_SECRET="trojkefkefokeofkef"
        )
        self.sonar = sonar
    ...
    def generate_results(self):
        ...
        component_tree_maintainability = list(
            self.sonar.measures.get_component_tree_with_specified_measures(
                component="project",
        ...
        component_tree_duplications = list(
            self.sonar.measures.get_component_tree_with_specified_measures(
                component="project",
        ...
        bugs = list(
            self.sonar.issues.search_issues(
                componentKeys="project", types="BUG")
        )
        ...
        code_smells = list(
            self.sonar.issues.search_issues(
                componentKeys="project", types="CODE_SMELL")
        )
        ...
        vulnerabilities = list(
            self.sonar.issues.search_issues(
                componentKeys="project", types="VULNERABILITY"
            )
        )
        ...
        mdFile = MdUtils(
            ...
            + "-"
            + "results",
            title="Analysis results for "
            + project_json["component"]["name"]
            + " project",
        )
        mdFile.new_paragraph(
            "This GitHub page shows the analysis results for the requested flow execution for "
            + project_json["component"]["name"]
            + "project"
        )
        ...
        data = [
            ...
            {"Issue type": "Vulnerabilities",
                "quantity": len(vulnerabilities_json)},
        ]
        ...
        for y in reliability:
            ...
            data.append(
                {
                    "file_name": y["name"],
                    "Lines_of_code": int(Lines_of_code_value),
                    "Remediation_effort": int(reliability_remediation_effort_value),
                    "reliability_rating": reliability_rating_value,
                    "bugs": float(bugs_value),
                }
            )
        data_table = gviz_api.DataTable(description)
        data_table.LoadData(data)
        ...
        jscode_reliability = data_table.ToJSCode(
            "jscode_data_reliability",
            [
                "file_name",
                "Lines_of_code",
                "Remediation_effort",
            ...
            data.append(
                {
                    ...
                    "Security_remediation_effort": int(
                        security_remediation_effort_value
                    ),
                    "security_rating": security_rating_value,
                    "vulnerabilities": float(vulnerabilities_value),
                }
            )
        data_table = gviz_api.DataTable(description)
        data_table.LoadData(data)
        ...
        jscode_security = data_table.ToJSCode(
            "jscode_data_security",
            [
                "file_name",
                "Lines_of_code",
            ...
            data.append(
                {
                    "file_name": y["name"],
                    "Lines_of_code": int(Lines_of_code_value),
                    "sqale_index": int(mantainability_remediation_effort_value),
                    "sqale_rating": maintainability_rating_value,
                    "code_smells": float(code_smells_value),
                }
            )
        ...
        jscode_maintainability = data_table.ToJSCode(
            "jscode_data_maintainability",
            [
                "file_name",
                "Lines_of_code",
                "sqale_index",
        ...
        for y in coverage:
            ...
            data.append(
                {
                    "file_name": y["name"],
                    "uncovered_lines": int(uncovered_lines_value),
        ...
        jscode_coverage = data_table.ToJSCode(
            ...
            data.append(
                {
                    "file_name": y["name"],
                    "Lines_of_code": int(Lines_of_code_value),
                    "duplicated_blocks": int(duplicated_blocks_value),
                    "ID": "",
                    "duplicated_lines": int(duplicated_lines_value),
                }
            )
        ...
        jscode_duplications = data_table.ToJSCode(
            "jscode_data_duplications",
            [
                "file_name",
                "Lines_of_code",
                "duplicated_lines",
