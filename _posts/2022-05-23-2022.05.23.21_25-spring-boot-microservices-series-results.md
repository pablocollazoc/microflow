...
<section id="downloads">
        <a href="{{ post.url }}" class="btn">SonarQube Scanner results</a>
        <a href="https://pablocollazoc.github.io/microflow/2022.05.23.21_25-spring-boot-microservices-series-results/checkstyle" class="btn">Checkstyle results</a>
        <a href="https://pablocollazoc.github.io/microflow/2022.05.23.21_25-spring-boot-microservices-series-results/spotbugs" class="btn">Spotbugs results</a>
...
{% include 2022.05.23.21_25-spring-boot-microservices-series-results-charts.html %}
# **Bugs found:**
